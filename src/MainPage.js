  ...
  const [schedule, setSchedule] = useState([
    {
      title: "직방 마감",
      description:
        "Smarthome(App) Product Owner\n직군 Product planning\n경력 10년 이상, 근무지 soma",
      id: "142",
      color: "#479950",
      isPrivate: true,
      description:
        "임시 내용1Smarthome(App) Product Owner 직군 Product planning경력 10년 이상, 근무지 soma",
      location: "토스본사",
    ...
    },
    {
      ...
      isPrivate: true,
      description:
        "개인정보를 취급하는 민간사업자 및 공공기관에서 개인정보 보호조치 사항에 대한 자율적인 점검을 통하여 개인정보 보호수준을 진단하고 개선할 수 있도록 지원하는 서비스입니다.            ",
      location: "집1",
      attachments: [
        {
          fileName: "testName1",
