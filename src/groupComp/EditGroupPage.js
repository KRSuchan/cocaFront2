...
const EditGroupPage = () => {
  ...
  const fetchGroupDetails = async groupId => {
    ...
    try {
      ...
      const res = await axios.post(
        process.env.REACT_APP_SERVER_URL + `/api/group/admin`,
        data,
        config
      );
      console.log(res);
  ...
  const updateGroup = async () => {
    ...
    let groupData = {
      ...
      notice: {
        contents:
          groupDetails.groupNotice === "" ? null : groupDetails.groupNotice,
      },
    ...
    try {
      ...
      const res = await axios.put(
        process.env.REACT_APP_SERVER_URL + "/api/group/update",
        groupData,
        config
      );
      console.log(res);
      ...
      <div className={styles.createGroupPageBox}>
        ...
        <div className={styles.createGroupPage}>
          ...
          <textarea
            ...
            onChange={e =>
              setGroupDetails({ ...groupDetails, groupNotice: e.target.value })
            }
            className={styles.textarea}
          />
          ...
          <div
                  ...
                  <>
                    ...
                    {index !== 0 && (
                      <div
                        ...
                        <button
                          onClick={() => handleManagerDelete(index)}
            ...
            <div
              ...
              <button
                onClick={() =>
                  openMemberModal(groupDetails.groupManagers.length)
                }
                className={styles.joinButton}>
                추가
              </button>
                  ...
                  .filter(
                    option =>
                      !groupDetails.groupTags.some(
                        (tag, tagIndex) =>
                          tag?.id === option.id && tagIndex !== index
                      )
                  )
                  .map(option => (
